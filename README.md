...
- Display name of the function, where error is occured (**NOTE:** This is disabled by default, to enable it read section Usage)
...
- **b_printFunctionName** to display name of the function, where error is occured
